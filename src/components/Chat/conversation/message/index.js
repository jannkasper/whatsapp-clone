    ...
    return (
        <div className={styles.outer}>
            <div className={styles.container}>
                { props.isOwner ? (
                    <div className={styles.container_ownerCorner}>
                    ...
                    <div className={styles.container_guestCorner}>
                ...
                <div className={[styles.message, props.isOwner ? styles.ownerMessage : styles.guestMessage].join(' ')}>
