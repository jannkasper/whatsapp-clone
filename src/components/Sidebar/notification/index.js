...
function Notification() {
    ...
    return (
        <div className={styles.notification}>
            <div className={styles.notification_inner}>
                ...
                <div className={styles.notification_text}>
                    <div className={styles.notification_firstLine}>Get notified of new messages</div>
                    <div className={styles.notification_secondLine}>
                        <span>
